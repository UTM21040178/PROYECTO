                                    ...
                                    event.metrics.map((metric, i) => (
                                        <Row className='mb-3' key={i}>
                                            ...
                                            <Col>
                                                ...
                                                <Form.Control onChange={(e:any)=>onChangeMetric(e,i)} type='number' name="max_points" />
                                            </Col>
                                            {
                                              event.metrics.length > 1 &&  (<Col xs={1}>
                                                <Button variant='danger' onClick={()=>removeMetric(i)}> <Trash/></Button>
                                                </Col>) 
                                            }
